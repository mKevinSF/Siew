<!DOCTYPE html>
<html>
<head><meta http-equiv="cache-control" content="no-cache"><meta http-equiv="Pragma" content="no-cache"><meta http-equiv="Expires" content="-1"><style type="text/css">/* Reset some default styles */
html, body {
    margin: 0;
    padding: 0;
}
...
/* Style the anime details section */
.anime-details {
    padding: 40px 0;
}
...
.anime__details__rating .rating a {
    color: #f39c12;
    text-decoration: none;
    margin-right: 5px;
}
...
.anime__details__review .anime__review__item {
    display: flex;
    margin-bottom: 20px;
}
...
/* Style the sidebar */
.anime__details__sidebar .product__sidebar__view__item {
    background: #fff;
    margin-bottom: 20px;
    border-radius: 5px;
    padding: 10px;
